...
<head>
  <title>Profile</title>
  <h1 ><img src="cl.jpg" alt="company" width="200" height="200"></h1>
</head>
<body>
<table align="center">
	<tr>
    <td> Logged in <a href="VIEW PROFILE.php"> MRx </a></td>
    <td><a href="LOGOUT.php"> Logout </a></td>
    </tr>
</table>

	<h2>PROFILE</h2>
	<img src="pp.jpg" alt="logo" width="100" height="100"><br><br>
	<a href="PROFILE PICTURE"> change </a>
	<p>Name: MRX</p>
	<p>Email: MRx@aiub.edu</p>
	<p>Gender: Male</p>
	<p>Date of Birth: 06/11/1998</p><br>
